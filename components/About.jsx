    ...
    <section id="about" className="w-full bg-[#0a0a0a] text-white py-16 sm:py-24 px-4 sm:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-12 sm:gap-20">
        ...
        <div className="flex flex-col items-start gap-4 sm:gap-5 border-b border-white/10 pb-8 sm:pb-10">
          ...
          {/* Section Main Title */}
          <h2 className="font-display font-bold text-3xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.6rem] tracking-tight text-white leading-[1.05] text-left select-none">
            ...
            <div key={project.id} className="flex flex-col gap-4 sm:gap-5 w-full group">
              ...
              <div className="flex items-center flex-wrap sm:flex-nowrap gap-2 sm:gap-3 w-full overflow-hidden">
                ...
                <Link
                  ...
                  className="font-display font-bold text-xl sm:text-3xl md:text-4xl text-white tracking-tight shrink-0 transition-colors duration-300 group-hover:text-[#a78bfa]"
                >
                  {project.title}
                </Link>
                <span className="font-display font-light text-zinc-600 text-xl sm:text-3xl shrink-0 select-none">:</span>
                <span className="font-jakarta font-normal text-zinc-400 text-sm sm:text-xl md:text-2xl tracking-tight truncate shrink">
                  {project.tagline}
                </span>
              </div>
              ...
              >
                <Link
                  href={`/projects/${project.id}`}
                  className="relative block w-full aspect-[16/10] sm:aspect-[16/9] rounded-[1.8rem] sm:rounded-[2.4rem] lg:rounded-[2.8rem] overflow-hidden border-2 border-white/10 bg-zinc-950 shadow-2xl group/card transition-all duration-500 ease-out hover:border-[#a78bfa]/40 hover:shadow-[0_25px_50px_rgba(0,0,0,0.9)]"
                >
